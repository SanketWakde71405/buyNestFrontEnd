 ...
 const {theme, lightTheme, darkTheme} = useTheme();
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="bg-gradient-to-br from-slate-50 via-violet-50 to-indigo-50 dark:bg-none dark:bg-slate-950 flex-1 flex flex-col overflow-y-auto gap-0 pb-20 md:pb-0">
        <NavBar
