...
function Auth() {
  ...
  return (
    <div className="flex flex-row w-full h-screen bg-gradient-to-br from-slate-50 via-violet-50 to-indigo-50">
      ...
      {/* Right column — Forms */}
      <div className="flex flex-col flex-1 w-[50%] h-screen  justify-center items-center">
        <div className="flex flex-col w-[80%] py-10 px-5 mx-10  bg-white rounded-lg shadow-xl z-20">
          {/*Form toggle Buttons Container  */}
