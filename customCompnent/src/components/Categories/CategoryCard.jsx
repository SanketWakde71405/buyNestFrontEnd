...
function CategoryCard({iconBackground, icon, title, subTitle, desc}) {
  return (
    <div className="flex flex-row bg-white dark:bg-slate-950 dark:border dark:border-slate-800 w-[30%] rounded-lg shadow-lg z-10 gap-2 justify-start items-start px-5 py-3">
      <div
