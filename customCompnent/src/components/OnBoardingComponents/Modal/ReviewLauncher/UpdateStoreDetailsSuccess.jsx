...
function UpdateStoreDetailsSuccess({ onClose }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="relative flex w-[90%] max-w-sm flex-col items-center justify-center rounded-lg bg-white p-5 text-center shadow-xl dark:bg-slate-900">
        ...
        />
        <img
          src="https://res.cloudinary.com/dx88pbasu/image/upload/v1786619780/success_light_bmfbwu.png"
          className="w-32 object-cover"
          alt="success.png"
        />

        <div className="flex flex-col px-4 py-2 my-2 mx-4 gap-2">
          <span className="text-base text-zinc-800 dark:text-gray-200 font-semibold">
            Store Details Updated <br />
            Successfully!
          </span>

          <span className="text-gray-500 dark:text-gray-400 text-sm ">
            Your store information has been updated successfully. You can change
            it anytime from <br />{" "}
            <span className="text-indigo-600">Store Settings.</span>
          </span>
        </div>
...
export default UpdateStoreDetailsSuccess;
